...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=\textbf{Three Core Problems}]
...
\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=\textbf{First-Order Logic Components}]
First-order logic achieves greater expressive power by introducing:
\begin{itemize}
